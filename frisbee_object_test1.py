...
#---------------------------------------------------------------------------------------------------#
  ...
  def get_force(self):
    ...
    print(F_lift, F_drag, F_gravity)
    print(test_fris.vhat(), F_drag/np.linalg.norm(F_drag))
    print(np.dot(F_drag, F_lift))
    return total_force
...
#Functions testing
test_fris=Frisbee(0.,0.,1.,10.,0.,5.,0.,0.,50.,16.,0.192,0.)
